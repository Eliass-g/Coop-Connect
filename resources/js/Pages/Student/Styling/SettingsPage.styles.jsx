...
export const Section = styled.section`
    ...
    border-color: ${({ darkMode }) =>
        darkMode ? "rgba(200, 200, 200, 1)" : "rgba(123, 117, 127, 1)"};
...
export const AccountHeader = styled.header`
    ...
    border-radius: 6px;
    border: 1px solid
        ${({ darkMode }) => (darkMode ? "#444" : "rgba(0, 0, 0, 1)")};
    align-self: center;
    display: flex;
    width: 100%;
...
export const DemoNotice = styled.div`
    color: ${({ darkMode }) => (darkMode ? "#FF7777" : "#D60000")};
...
export const SettingsOptions = styled.div`
    border-radius: 6px;
    border: 1px solid
        ${({ darkMode }) => (darkMode ? "#666" : "rgba(0, 0, 0, 1)")};
...
export const OptionButton = styled.button`
    ...
    background-color: ${({ className, darkMode }) =>
        (className === "private" || className === "public") && darkMode
            ? "#543b6f"
            : className === "private" || className === "public"
            ? "#6b538c"
            : "transparent"};
    color: ${({ className, darkMode }) =>
        className === "private" || className === "public"
            ? "#fff"
            : darkMode
            ? "#ddd"
...
export const OtherOptionButton = styled.button`
    ...
    background: ${({ active, darkMode }) =>
        active ? "#6B538C" : darkMode ? "#555" : "#E0E0E0"};
    color: ${({ active, darkMode }) =>
        active ? "#FFF" : darkMode ? "#ddd" : "#000"};
    border: none;
    border-radius: 5px;
    user-select: none;
    font-size: ${({ fontSize }) => fontSize};
    ...
    &:hover {
        background: ${({ active, darkMode }) =>
            active ? "#0056b3" : darkMode ? "#666" : "#c7c7c7"};
    }
`;
...
export const SaveOptionButton = styled.button`
    ...
    cursor: pointer;
    background: ${({ active, darkMode }) =>
        active ? "#6B538C" : darkMode ? "#006400" : "#66CC66"};
    color: ${({ active, darkMode }) =>
        active ? "#FFF" : darkMode ? "#ddd" : "#FFF"};
    border: none;
    border-radius: 5px;
    user-select: none;
    font-size: ${({ fontSize }) => fontSize};
    ...
    &:hover {
        background: ${({ active, darkMode }) =>
            active ? "#0056b3" : darkMode ? "#66CC66" : "#006400"};
    }
`;
...
export const SubmitButton = styled.button`
    ...
    border-radius: 5px;
    background-color: ${({ darkMode }) =>
        darkMode ? "rgb(83, 63, 100)" : "rgb(107,83,140)"};
    color: #fff;
    font-size: ${({ fontSize }) => fontSize};
    cursor: pointer;
    align-self: flex-end;
...
export const Message = styled.p`
    color: ${({ error, darkMode }) =>
        error ? "red" : darkMode ? "lightgreen" : "green"};
    font-size: ${({ fontSize }) => fontSize};
    transition: color 0.5s ease;
`;
