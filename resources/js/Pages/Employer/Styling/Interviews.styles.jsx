...
export const Header = styled.div`
    ...
    align-self: center;
    font: 600 ${({ fontSize }) =>
        calculateFontSize(28, fontSize)} Poppins, sans-serif;
    margin-bottom: 20px;
    @media (max-width: 991px) {
       font: 600 ${({ fontSize }) =>
           calculateFontSize(24, fontSize)} Poppins, sans-serif;
`;
...
export const CalendarDiv = styled.div`
    ...
    border-color: ${({ darkMode }) =>
        darkMode ? "#444444" : "rgba(123, 117, 127, 1)"};
    background-color: ${({ darkMode }) => (darkMode ? "#3C3C3C" : "#fff")};
    color: ${({ darkMode }) => (darkMode ? "#EDDCFF" : "#6b538c")};
...
export const Month = styled.div`
    color: ${({ darkMode }) => (darkMode ? "#EDDCFF" : "#6b538c")};
    margin: auto 0;
    font: 900 ${({ fontSize }) => calculateFontSize(24, fontSize)} Inter,
        sans-serif;
...
export const GlobalStyles = createGlobalStyle`
  ...
  .rbc-btn-group button {
    font-size: ${({ fontSize }) => calculateFontSize(14, fontSize)};
    color: ${({ darkMode }) =>
        darkMode ? "#FFF" : "#6B538C"}; /* Main color for labels */
    transition: color 0.3s, background-color 0.3s;
  }

  .rbc-btn-group button:hover {
    color: ${({ darkMode }) =>
        darkMode ? "#FFFFFF" : "#543b6f"}; /* Hover color */
  }
