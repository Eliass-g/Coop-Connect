import{f as d,p as e}from"./styled-components.browser.esm-WlhnpHHw.js";import"./app-BP2DlbBf.js";const r=(o,n,a=1.5,s="rem")=>{const t=parseFloat(n);if(s==="rem"){const i=o/16;return n==="1em"?`${i*t}rem`:n==="1.07em"?`${i*t*1.3}rem`:n==="1.12em"?`${i*t*1.7}rem`:`${i*t*a}rem`}if(s==="vw"){const i=o/100;return n==="1em"?`${i*t}vw`:n==="1.07em"?`${i*t*1.3}vw`:n==="1.12em"?`${i*t*1.7}vw`:`${i*t*a}vw`}},c=d`
