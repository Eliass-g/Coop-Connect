import{r as s,j as e}from"./app-BP2DlbBf.js";import{p as o}from"./styled-components.browser.esm-WlhnpHHw.js";const R="#FFFFFF",W="#333333",c=(t,l,d=1.5)=>{const p=parseFloat(l);return l==="1em"?`${t*p}px`:l==="1.07em"?`${t*p*1.3}px`:l==="1.12em"?`${t*p*1.7}px`:`${t*p*d}px`},q=o.div`
    position: fixed;
    top: 50%;
    left: 50%;
