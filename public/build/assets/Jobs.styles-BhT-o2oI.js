import{f as r,p as i}from"./styled-components.browser.esm-C7o4QOmv.js";import{F as a}from"./index.es-CWqCd6w8.js";import"./app-DAlFUNO8.js";import"./index-BX7LP9oL.js";const t=(o,e,s=1.5)=>{const n=parseFloat(e);return e==="1em"?`${o*n}px`:e==="1.07em"?`${o*n*1.3}px`:e==="1.12em"?`${o*n*1.7}px`:`${o*n*s}px`},p=r`
    from {
        opacity: 0;
    }
    to {
