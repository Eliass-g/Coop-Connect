import{f as a,p as e,h as s}from"./styled-components.browser.esm-Cye39UAp.js";import"./app-pcpPOzh4.js";const t=(o,r,i=1.5)=>{const n=parseFloat(r);return r==="1em"?`${o*n}px`:r==="1.07em"?`${o*n*1.3}px`:r==="1.12em"?`${o*n*1.7}px`:`${o*n*i}px`},c=a`
    from {
        opacity: 0;
    }
    to {
