import{f as r,p as i}from"./styled-components.browser.esm-WlhnpHHw.js";import{F as a}from"./index.es-Cq2d97-S.js";import"./app-BP2DlbBf.js";import"./index-DUoLStMl.js";const t=(o,e,s=1.5)=>{const n=parseFloat(e);return e==="1em"?`${o*n}px`:e==="1.07em"?`${o*n*1.3}px`:e==="1.12em"?`${o*n*1.7}px`:`${o*n*s}px`},p=r`
    from {
        opacity: 0;
    }
    to {
