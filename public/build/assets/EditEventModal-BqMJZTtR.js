import{r as n,j as i}from"./app-DNWayCnB.js";import{p as s}from"./styled-components.browser.esm-B0h7x_ce.js";const B="#FFFFFF",I="#333333",e=(t,d,r=1.5)=>{const o=parseFloat(d);return d==="1em"?`${t*o}px`:d==="1.07em"?`${t*o*1.3}px`:d==="1.12em"?`${t*o*1.7}px`:`${t*o*r}px`},z=s.div`
  position: fixed;
  top: 50%;
  left: 50%;
